...
class detail
{
	public:
		...
		int d,m,y;
//************************************************************
// Function to get details of train by adninistrator
//************************************************************ 
		void getdetail()
		{
			system("cls");
...
//************************************************************
//Function to display details of trains
//************************************************************
		void displaydetail()
		{
			system("cls");
...
class reser
{
	...
	int con;
	     float amc;
//************************************************************
//Funtion to get details for reservation
//************************************************************
	     void getresdet()
	     {
		    system("cls");
...
class canc
{
	...
	float amr;
//************************************************************
//Function to get details for cancellation
//************************************************************
	void getcancdet()
	{
		system("cls");
...
//************************************************************
//Function to display details of cancelled resrvation
//************************************************************
	void displaycancdet()
	{
		system("cls");
...
cout<<"SYSTEM";
gotoxy(3,23);
cout<<"MADE BY : UJJAWAL , PRAKHAR , VIDHU , SHUBHAM";
gotoxy(3,25);
cout<<" SCHOOL : ST. PETER SR. SEC. SCHOOL";
getch();
}
